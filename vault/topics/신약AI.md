...
---
## 2026-W38 핵심 흐름
W38 신약AI는 면역 시스템의 다층위(multiscale) 동학을 통합한 월드 모델(면역 월드 모델, arXiv:2609.14709)과 EHR 사전학습 표현으로 약물 재창출 후보를 실용적으로 스크리닝하는 접근(arXiv:2609.19865)이 두 핵심이다. 전자는 치료 가설 생성과 다층위 예측을 단일 프레임워크로 연결하고, 후자는 대형 인프라 없이 EHR 임상 데이터에서 재창출 신호를 직접 추출한다는 점에서 데이터 효율·접근성 양면의 진전을 보인다.
...
- [[면역-월드-모델]] — 면역 다층위 동학 통합 월드 모델, 다중 인체 조직 세포 상태 예측 + 치료 가설 생성 내장 (arXiv:2609.14709) [preprint]
- [[EHR-약물재창출]] — EHR 사전학습 표현으로 약물 재창출 후보 실용적 스크리닝, 대형 인프라 불필요한 데이터 효율 접근 (arXiv:2609.19865) [preprint]
